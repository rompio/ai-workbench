...
class CustomUser(AbstractUser):
    ...
    job_title = models.CharField(max_length=100, blank=True, null=True, choices=JOB_TITLE_CHOICES)
    ...
    is_verified = models.BooleanField(default=False)  # For handling email verification or admin approval
